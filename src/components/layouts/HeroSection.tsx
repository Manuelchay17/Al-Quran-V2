...
const HeroSection = () => {
  return (
    <div className="w-full">
      ...
      <div className="md:flex flex-col md:h-auto h-auto px-4 md:px-20">
        <Card />
      </div>

      <div className="mt-16">
        <h1 className="text-3xl text-center">Cari Surat Al-Quran</h1>
        <p className="text-lg text-white/50 text-center mt-2">
